...
import { ShoppingCart, Package } from 'lucide-react'; // Make sure you install lucide-react (e.g., npm install lucide-react)
...
export default function Navbar() {
  ...
  return (
    // Updated: Darker background, border for depth, and slightly larger padding
    <nav className="bg-slate-900 shadow-xl border-b border-sky-500/50">
      <div className="container mx-auto px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link 
            to="/cart" 
            // Updated: Cool blue background, rounded, padding, and subtle shadow for a button feel
          ...
          >
            ...
            {/* Cart Count Badge */}
            <span 
              // Updated: Small, circular, contrasting badge with a pop of color
